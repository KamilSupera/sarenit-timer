      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-12 lg:py-16">
        <header className="anim-rise relative z-20 mb-12 border-b-2 border-border pb-8">
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div>
              <p className="anim-slide-left label-caps">Est. 1996 · Sarenit Engineer Factory</p>
        ...
        <footer className="mt-16 border-t-2 border-border pt-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <p className="label-caps">Est. 1996 · Sarenit Engineer Factory</p>
            <p className="text-xs text-smoke">
              Every case file stays in this browser. Nothing is sent anywhere.
            </p>
            <a
              href="https://github.com/KamilSupera/sarenit-timer"
              target="_blank"
              rel="noreferrer"
              className="font-caps text-xs tracking-[0.2em] text-muted-foreground uppercase hover:text-gold"
            >
              Source on GitHub
            </a>
          </div>
